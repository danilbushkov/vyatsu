...
pub const TASK4_TEXT: &'static str = "Функция хеширования.
Реализовать алгоритм криптографической функции – Tiger.
Зашифруйте сообщение: Многие люди подобны колбасам: чем их начинят, то и носят в себе.";

pub const TASK5_TEXT: &'static str = "Электронная цифровая подпись.
Используя хеш-образ строки: << Общие принципы только в головах, а в жизни
