...
class SubtractArea(Frame):
    ...
    def __init__(self, parent=None):
        ...
        self.label_name = Label(master=self, text="Вычитание матриц")
        ...
        self.btn = Button(self, text="Вычесть", command=self.handler)
