...
fn test_logic() {
    ...
    check_ch(pp, pn, "2", 
    b32_to_f64(0b0_10000100_10000000000000000000000), 
    b32_to_f64(0b0_10000100_10000000000000000000000),
    b32_to_f64(0b1_10000011_11111111111111111111110), 
    "00000101");

    check_ch(pp, pn, "2", 
    b32_to_f64(0b0_00000000_10000000000000000000000), 
    b32_to_f64(0b0_00000000_10000000000000000000000),
    0.0, 
    "00000011");

    check_ch(pp, pn, "2", 
    b32_to_f64(0b0_10000000_00000000000000000000000), 
    b32_to_f64(0b0_10000000_00000000000000000000000),
    b32_to_f64(0b1_10000000_11111111111111111111111), 
    "00000101");

    check_ch(pp, pn, "2", 
    b32_to_f64(0b0_10010110_10001111111100000000000), 
    b32_to_f64(0b0_10000000_11110000000011111111110),
    b32_to_f64(0b1_10000000_10000000000000000000000), 
    "00000101");
}
